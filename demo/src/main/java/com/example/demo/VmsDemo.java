...
public class VmsDemo {
    ...
    static final String accessKeyId = "LTAIl7LGNO1ev861";
    static final String accessKeySecret = "K4AX0X2ndOsgtdEUE1c06DOkMiClUW";
    
    //外呼显示号码
    static final String Number = "02160782528";
     ...
     */
    public static SingleCallByTtsResponse singleCallByTts(String product,String price,String phoneNumber) throws ClientException {


        //组装请求对象-具体描述见控制台-文档部分内容
        SingleCallByTtsRequest request = new SingleCallByTtsRequest();
        //必填-被叫显号,可在语音控制台中找到所购买的显号
        request.setCalledShowNumber(Number);
        //必填-被叫号码
        request.setCalledNumber(phoneNumber);
        //必填-Tts模板ID
        request.setTtsCode("TTS_138685007");
        //可选-当模板中存在变量时需要设置此值
        request.setTtsParam("{\"product\":\""+product+"\",\"code\":\""+price+"\"}");
...
//        System.out.println(singleCallByVoiceResponse.getMessage()+"-----------------");
